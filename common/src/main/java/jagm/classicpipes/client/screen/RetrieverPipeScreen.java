...
import jagm.classicpipes.inventory.menu.RetrieverPipeMenu;
...
public class RetrieverPipeScreen extends FilterScreen<RetrieverPipeMenu> {

    private static final Identifier BACKGROUND = MiscUtil.identifier("textures/gui/container/networked_pipe.png");

    public RetrieverPipeScreen(RetrieverPipeMenu menu, Inventory playerInventory, Component title) {

...
public class RetrieverPipeMenu extends FilterMenu {

    private boolean defaultRoute;

    public RetrieverPipeMenu(int id, Inventory playerInventory, ClientBoundTwoBoolsPayload payload) {
    ...
    public RetrieverPipeMenu(int id, Inventory playerInventory, Filter filter, boolean defaultRoute) {
